  ...
  return (
    <CometCard className="w-full max-w-sm mx-auto">
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-[14px] bg-gradient-to-br from-slate-900 via-purple-950 to-slate-900 p-6">
          {/* Purple sparkle particles */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-[10%] left-[15%] w-1 h-1 bg-purple-400 rounded-full animate-ping" style={{animationDelay: '0s'}}></div>
            <div className="absolute top-[25%] right-[20%] w-1.5 h-1.5 bg-violet-300 rounded-full animate-ping" style={{animationDelay: '0.5s'}}></div>
            <div className="absolute bottom-[30%] left-[25%] w-1 h-1 bg-fuchsia-400 rounded-full animate-ping" style={{animationDelay: '1s'}}></div>
            <div className="absolute bottom-[15%] right-[15%] w-1.5 h-1.5 bg-purple-300 rounded-full animate-ping" style={{animationDelay: '1.5s'}}></div>
            <div className="absolute top-[40%] right-[10%] w-1 h-1 bg-violet-400 rounded-full animate-ping" style={{animationDelay: '2s'}}></div>
          </div>
          {/* Brand Logo */}
          <div className="absolute top-4 left-4 z-10">
            <div className="flex items-center gap-2 bg-slate-800/80 backdrop-blur-sm px-3 py-1.5 rounded-full border border-purple-500/30">
              <Image
              ...
              />
              <span className="text-xs font-semibold text-purple-400 tracking-wide">MARKETVIEW360</span>
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-col items-center mb-6">
            <div className="relative mb-4">
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500 to-fuchsia-500 blur-xl opacity-50 animate-pulse"></div>
              <UserAvatar 
                user={user} 
                size="lg" 
        ...
        <div className="absolute -inset-[1px] rounded-[16px] bg-gradient-to-r from-purple-500 via-fuchsia-500 to-purple-500 opacity-75 blur-sm animate-pulse"></div>
      </div>
    </CometCard>
  );
}
