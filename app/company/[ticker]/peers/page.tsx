...
export default async function PeersPage({ params }: { params: Promise<{ ticker: string }> }) {
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-20">
            ...
            <div className="mx-auto max-w-[1600px] py-8 px-4 md:px-8 lg:px-12">
                <div className="max-w-4xl mx-auto">
                    <Suspense fallback={<div className="h-96 bg-white dark:bg-slate-900 animate-pulse rounded-xl" />}>
                        <PeerComparison ticker={ticker} sector={company.sector} exchange={company.exchange} />
                    </Suspense>
                </div>
            </div>
        </div>
