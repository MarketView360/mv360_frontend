      ...
      <div className="mx-auto max-w-[1400px] px-4 md:px-8 py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        >
          <input
            ...
            className="w-40 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand"
          />
          <input
            ref={qRef}
            name="q"
            ...
            className="w-64 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand"
          />
